...
import com.guyj.utils.ClickUtils;
...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public String getEditTextContent(int viewId) {
        String result;
        ...
        if (getView(viewId) != null) {
            ...
            view.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    if (null != easyOnItemChildTouchListener && getLayoutPosition() == getAdapterPosition() && getAdapterPosition() != -1 && !ClickUtils.isFastClick()) {
